...
class Ui_PreF025Dialog(object):
    def setupUi(self, PreF025Dialog):
        ...
        self.gridLayout_2.addWidget(self.btnAddActionTypes, 2, 2, 1, 1)
        self.edtNameFilter = QtGui.QLineEdit(self.grpActions)
        self.edtNameFilter.setObjectName(_fromUtf8("edtNameFilter"))
        self.gridLayout_2.addWidget(self.edtNameFilter, 1, 0, 1, 4)
        ...
        PreF025Dialog.setTabOrder(self.tblActions, self.edtNameFilter)
        PreF025Dialog.setTabOrder(self.edtNameFilter, self.btnSelectActions)
        PreF025Dialog.setTabOrder(self.btnSelectActions, self.btnDeselectActions)
        PreF025Dialog.setTabOrder(self.btnDeselectActions, self.btnAddActionTypes)
        PreF025Dialog.setTabOrder(self.btnAddActionTypes, self.buttonBox)
    ...
    def retranslateUi(self, PreF025Dialog):
        ...
        self.btnAddActionTypes.setText(_translate("PreF025Dialog", "Добавить", None))
