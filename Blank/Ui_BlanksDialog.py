...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\Blank\BlanksDialog.ui'
#
...
class Ui_BlanksDialog(object):
    def setupUi(self, BlanksDialog):
        ...
        self.tabTempInvalidTypeELN = QtGui.QTabWidget(self.tabTypeTempInvalid)
        self.tabTempInvalidTypeELN.setObjectName(_fromUtf8("tabTempInvalidTypeELN"))
        self.tabBlank = QtGui.QWidget()
        self.tabBlank.setObjectName(_fromUtf8("tabBlank"))
        self.gridLayout_13 = QtGui.QGridLayout(self.tabBlank)
        self.gridLayout_13.setObjectName(_fromUtf8("gridLayout_13"))
        self.splitter_3 = QtGui.QSplitter(self.tabBlank)
        ...
        self.gridLayout_10.addWidget(self.cmbPersonParty, 0, 1, 1, 6)
        ...
        self.gridLayout_10.addWidget(self.edtBegDateParty, 1, 1, 1, 2)
        spacerItem = QtGui.QSpacerItem(118, 13, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_10.addItem(spacerItem, 1, 5, 1, 2)
        ...
        self.gridLayout_10.addWidget(self.edtSerialParty, 2, 1, 1, 6)
        ...
        self.gridLayout_10.addWidget(self.edtNumberFrom, 3, 1, 1, 1)
        spacerItem1 = QtGui.QSpacerItem(89, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_10.addItem(spacerItem1, 3, 6, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.cmbOrgStructureSubParty, 0, 1, 1, 4)
        ...
        self.gridLayout_6.addWidget(self.cmbPersonSubParty, 1, 1, 1, 4)
        ...
        self.gridLayout_6.addWidget(self.edtBegDateSubParty, 2, 1, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.edtEndDateSubParty, 2, 3, 1, 1)
        ...
        self.tabTempInvalidTypeELN.addTab(self.tabBlank, _fromUtf8(""))
        self.tabElectronic = QtGui.QWidget()
        self.tabElectronic.setObjectName(_fromUtf8("tabElectronic"))
        self.gridLayout_12 = QtGui.QGridLayout(self.tabElectronic)
        self.gridLayout_12.setObjectName(_fromUtf8("gridLayout_12"))
        self.splitter_8 = QtGui.QSplitter(self.tabElectronic)
        ...
        self.treeBlankTypeTempInvalidEl = CTreeView(self.splitter_7)
        self.treeBlankTypeTempInvalidEl.setObjectName(_fromUtf8("treeBlankTypeTempInvalidEl"))
        self.grbTempInvalidFilterEl = QtGui.QGroupBox(self.splitter_7)
        self.grbTempInvalidFilterEl.setObjectName(_fromUtf8("grbTempInvalidFilterEl"))
        self.gridLayout_11 = QtGui.QGridLayout(self.grbTempInvalidFilterEl)
        self.gridLayout_11.setObjectName(_fromUtf8("gridLayout_11"))
        self.chkFreeEl = QtGui.QCheckBox(self.grbTempInvalidFilterEl)
        self.chkFreeEl.setChecked(True)
        self.chkFreeEl.setObjectName(_fromUtf8("chkFreeEl"))
        self.gridLayout_11.addWidget(self.chkFreeEl, 4, 1, 1, 4)
        spacerItem4 = QtGui.QSpacerItem(89, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_11.addItem(spacerItem4, 3, 6, 1, 1)
        self.cmbPersonPartyEl = CPersonComboBoxEx(self.grbTempInvalidFilterEl)
        self.cmbPersonPartyEl.setObjectName(_fromUtf8("cmbPersonPartyEl"))
        self.gridLayout_11.addWidget(self.cmbPersonPartyEl, 0, 1, 1, 6)
        self.lblPersonPartyEl = QtGui.QLabel(self.grbTempInvalidFilterEl)
        self.lblPersonPartyEl.setObjectName(_fromUtf8("lblPersonPartyEl"))
        self.gridLayout_11.addWidget(self.lblPersonPartyEl, 0, 0, 1, 1)
        self.lblDatePartyEl = QtGui.QLabel(self.grbTempInvalidFilterEl)
        self.lblDatePartyEl.setObjectName(_fromUtf8("lblDatePartyEl"))
        self.gridLayout_11.addWidget(self.lblDatePartyEl, 1, 0, 1, 1)
        self.labelEl = QtGui.QLabel(self.grbTempInvalidFilterEl)
        self.labelEl.setObjectName(_fromUtf8("labelEl"))
        self.gridLayout_11.addWidget(self.labelEl, 1, 3, 1, 1)
        spacerItem5 = QtGui.QSpacerItem(118, 13, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_11.addItem(spacerItem5, 1, 5, 1, 2)
        self.lblNumberEl = QtGui.QLabel(self.grbTempInvalidFilterEl)
        self.lblNumberEl.setObjectName(_fromUtf8("lblNumberEl"))
        self.gridLayout_11.addWidget(self.lblNumberEl, 3, 0, 1, 1)
        self.edtBegDatePartyEl = CDateEdit(self.grbTempInvalidFilterEl)
        self.edtBegDatePartyEl.setCalendarPopup(True)
        self.edtBegDatePartyEl.setObjectName(_fromUtf8("edtBegDatePartyEl"))
        self.gridLayout_11.addWidget(self.edtBegDatePartyEl, 1, 1, 1, 2)
        self.edtSerialPartyEl = QtGui.QLineEdit(self.grbTempInvalidFilterEl)
        self.edtSerialPartyEl.setObjectName(_fromUtf8("edtSerialPartyEl"))
        self.gridLayout_11.addWidget(self.edtSerialPartyEl, 2, 1, 1, 6)
        spacerItem6 = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout_11.addItem(spacerItem6, 6, 2, 1, 1)
        self.edtEndDatePartyEl = CDateEdit(self.grbTempInvalidFilterEl)
        self.edtEndDatePartyEl.setObjectName(_fromUtf8("edtEndDatePartyEl"))
        self.gridLayout_11.addWidget(self.edtEndDatePartyEl, 1, 4, 1, 1)
        self.lblSerialPartyEl = QtGui.QLabel(self.grbTempInvalidFilterEl)
        self.lblSerialPartyEl.setObjectName(_fromUtf8("lblSerialPartyEl"))
        self.gridLayout_11.addWidget(self.lblSerialPartyEl, 2, 0, 1, 1)
        self.buttonBoxFilterEl = QtGui.QDialogButtonBox(self.grbTempInvalidFilterEl)
        self.buttonBoxFilterEl.setStandardButtons(QtGui.QDialogButtonBox.Apply|QtGui.QDialogButtonBox.Reset)
        self.buttonBoxFilterEl.setObjectName(_fromUtf8("buttonBoxFilterEl"))
        self.gridLayout_11.addWidget(self.buttonBoxFilterEl, 7, 0, 1, 7)
        self.edtNumberToEl = QtGui.QSpinBox(self.grbTempInvalidFilterEl)
        self.edtNumberToEl.setMaximum(99999999)
        self.edtNumberToEl.setObjectName(_fromUtf8("edtNumberToEl"))
        self.gridLayout_11.addWidget(self.edtNumberToEl, 3, 4, 1, 1)
        self.labelActionsEl = QtGui.QLabel(self.grbTempInvalidFilterEl)
        self.labelActionsEl.setObjectName(_fromUtf8("labelActionsEl"))
        self.gridLayout_11.addWidget(self.labelActionsEl, 3, 3, 1, 1)
        self.edtNumberFromEl = QtGui.QSpinBox(self.grbTempInvalidFilterEl)
        self.edtNumberFromEl.setMaximum(99999999)
        self.edtNumberFromEl.setObjectName(_fromUtf8("edtNumberFromEl"))
        self.gridLayout_11.addWidget(self.edtNumberFromEl, 3, 1, 1, 2)
        self.chkExtraditedEl = QtGui.QCheckBox(self.grbTempInvalidFilterEl)
        self.chkExtraditedEl.setObjectName(_fromUtf8("chkExtraditedEl"))
        self.gridLayout_11.addWidget(self.chkExtraditedEl, 5, 1, 1, 4)
        self.widget = QtGui.QWidget(self.splitter_8)
        self.widget.setObjectName(_fromUtf8("widget"))
        self.gridLayout_9 = QtGui.QGridLayout(self.widget)
        self.gridLayout_9.setObjectName(_fromUtf8("gridLayout_9"))
        self.tblBlankTempInvalidPartyEl = CInDocTableView(self.widget)
        self.tblBlankTempInvalidPartyEl.setSelectionMode(QtGui.QAbstractItemView.SingleSelection)
        self.tblBlankTempInvalidPartyEl.setSelectionBehavior(QtGui.QAbstractItemView.SelectRows)
        self.tblBlankTempInvalidPartyEl.setObjectName(_fromUtf8("tblBlankTempInvalidPartyEl"))
        self.gridLayout_9.addWidget(self.tblBlankTempInvalidPartyEl, 0, 0, 1, 1)
        self.lblCountRecordsEl = QtGui.QLabel(self.widget)
        self.lblCountRecordsEl.setObjectName(_fromUtf8("lblCountRecordsEl"))
        self.gridLayout_9.addWidget(self.lblCountRecordsEl, 1, 0, 1, 1)
        self.gridLayout_12.addWidget(self.splitter_8, 0, 0, 1, 1)
        self.tabTempInvalidTypeELN.addTab(self.tabElectronic, _fromUtf8(""))
        self.gridLayout_4.addWidget(self.tabTempInvalidTypeELN, 0, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.cmbPersonPartyActions, 0, 1, 1, 6)
        ...
        self.gridLayout_7.addWidget(self.edtBegDatePartyActions, 1, 1, 1, 2)
        spacerItem7 = QtGui.QSpacerItem(118, 13, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_7.addItem(spacerItem7, 1, 5, 1, 2)
        ...
        self.gridLayout_7.addWidget(self.edtSerialPartyActions, 2, 1, 1, 6)
        ...
        self.gridLayout_7.addWidget(self.edtNumberFromActions, 3, 1, 1, 1)
        self.labelActions = QtGui.QLabel(self.grbPartyActions)
        self.labelActions.setObjectName(_fromUtf8("labelActions"))
        self.gridLayout_7.addWidget(self.labelActions, 3, 2, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.edtNumberToActions, 3, 5, 1, 1)
        spacerItem8 = QtGui.QSpacerItem(89, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_7.addItem(spacerItem8, 3, 6, 1, 1)
        self.label_3 = QtGui.QLabel(self.grbPartyActions)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.gridLayout_7.addWidget(self.label_3, 1, 3, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.edtEndDatePartyActions, 1, 4, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.cmbOrgStructureSubPartyActions, 0, 1, 1, 4)
        ...
        self.gridLayout_5.addWidget(self.cmbPersonSubPartyActions, 1, 1, 1, 4)
        ...
        self.gridLayout_5.addWidget(self.edtBegDateSubPartyActions, 2, 1, 1, 1)
        spacerItem9 = QtGui.QSpacerItem(108, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_5.addItem(spacerItem9, 2, 4, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.edtEndDateSubPartyActions, 2, 3, 1, 1)
        ...
        self.tabTempInvalidTypeELN.setCurrentIndex(0)
    ...
    def retranslateUi(self, BlanksDialog):
        ...
        self.lblDateParty.setText(_translate("BlanksDialog", "Дата с", None))
        self.edtBegDateParty.setDisplayFormat(_translate("BlanksDialog", "dd.MM.yyyy", None))
        self.lblSerialParty.setText(_translate("BlanksDialog", "Серия", None))
        self.lblNumber.setText(_translate("BlanksDialog", "Номер с", None))
        self.label.setText(_translate("BlanksDialog", "по", None))
        self.edtEndDateParty.setDisplayFormat(_translate("BlanksDialog", "dd.MM.yyyy", None))
        ...
        self.lblDateSubParty.setText(_translate("BlanksDialog", "Дата с", None))
        self.label_2.setText(_translate("BlanksDialog", "по", None))
        self.tabTempInvalidTypeELN.setTabText(self.tabTempInvalidTypeELN.indexOf(self.tabBlank), _translate("BlanksDialog", "Бланки", None))
        self.grbTempInvalidFilterEl.setTitle(_translate("BlanksDialog", "Фильтр", None))
        self.chkFreeEl.setText(_translate("BlanksDialog", "Доступно", None))
        self.lblPersonPartyEl.setText(_translate("BlanksDialog", "Получатель", None))
        self.lblDatePartyEl.setText(_translate("BlanksDialog", "Дата с", None))
        self.labelEl.setText(_translate("BlanksDialog", "по", None))
        self.lblNumberEl.setText(_translate("BlanksDialog", "Номер с", None))
        self.edtBegDatePartyEl.setDisplayFormat(_translate("BlanksDialog", "dd.MM.yyyy", None))
        self.edtEndDatePartyEl.setDisplayFormat(_translate("BlanksDialog", "dd.MM.yyyy", None))
        self.lblSerialPartyEl.setText(_translate("BlanksDialog", "Серия", None))
        self.labelActionsEl.setText(_translate("BlanksDialog", "по", None))
        self.chkExtraditedEl.setText(_translate("BlanksDialog", "Использованно", None))
        self.lblCountRecordsEl.setText(_translate("BlanksDialog", "Список пуст", None))
        self.tabTempInvalidTypeELN.setTabText(self.tabTempInvalidTypeELN.indexOf(self.tabElectronic), _translate("BlanksDialog", "Электронные", None))
        ...
        self.lblDatePartyActions.setText(_translate("BlanksDialog", "Дата с", None))
        self.lblSerialPartyActions.setText(_translate("BlanksDialog", "Серия", None))
        self.lblNumberActions.setText(_translate("BlanksDialog", "Номер с", None))
        self.labelActions.setText(_translate("BlanksDialog", "по", None))
        self.label_3.setText(_translate("BlanksDialog", "по", None))
