...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\Quoting\EventsListDialog.ui'
#
...
class Ui_EventsListDialog(object):
    ...
    def retranslateUi(self, EventsListDialog):
        EventsListDialog.setWindowTitle(_translate("EventsListDialog", "События", None))
