...
-- Таблицы с данными
 ...
 `code` VARCHAR( 15 ) NOT NULL COMMENT 'код медицинской услуги',
...
CREATE TEMPORARY TABLE IF NOT EXISTS `tmpStandart` (
 `code` VARCHAR( 15 ) NOT NULL COMMENT 'код стандарта',
...
`code` VARCHAR( 15 ) NOT NULL COMMENT 'код стандарта оказания медицинской помощи',
 `code_pr` VARCHAR( 15 ) NOT NULL COMMENT 'код простой ,сложной и комплексной медицинской услуги',
...
`mkbx` VARCHAR( 5 ) NOT NULL COMMENT 'Код МКБ',
 `kstand` VARCHAR( 15 ) NOT NULL COMMENT 'Код стандарта оказания  медицинской помощи',
...
-- временная таблица для вхождения услуг в лекарства
 ...
 `KSTAND` VARCHAR( 15 ) NOT NULL COMMENT 'Код стандарта ОМП',
 `CODETRN` VARCHAR( 10 ) NOT NULL COMMENT 'Код торгового наименования',
