...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\Registry\CheckEnteredOpenEventsDialog.ui'
#
...
class Ui_CheckEnteredOpenEventsDialog(object):
    def setupUi(self, CheckEnteredOpenEventsDialog):
        ...
        CheckEnteredOpenEventsDialog.setTabOrder(self.btnClose, self.btnReverse)
        CheckEnteredOpenEventsDialog.setTabOrder(self.btnReverse, self.btnOpen)
        CheckEnteredOpenEventsDialog.setTabOrder(self.btnOpen, self.btnCreate)
        CheckEnteredOpenEventsDialog.setTabOrder(self.btnCreate, self.tblOpenEvents)
