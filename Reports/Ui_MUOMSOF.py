...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\Reports\MUOMSOF.ui'
#
...
class Ui_MUOMSOFSetupDialog(object):
    def setupUi(self, MUOMSOFSetupDialog):
        ...
        MUOMSOFSetupDialog.resize(339, 446)
        MUOMSOFSetupDialog.setSizeGripEnabled(True)
        self.gridLayout = QtGui.QGridLayout(MUOMSOFSetupDialog)
        self.gridLayout.setMargin(4)
        self.gridLayout.setSpacing(4)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.cmbFinance = CRBComboBox(MUOMSOFSetupDialog)
        self.cmbFinance.setObjectName(_fromUtf8("cmbFinance"))
        self.gridLayout.addWidget(self.cmbFinance, 8, 1, 1, 2)
        self.lblFinance = QtGui.QLabel(MUOMSOFSetupDialog)
        ...
        self.cmbGroupType.addItem(_fromUtf8(""))
        self.cmbGroupType.addItem(_fromUtf8(""))
        self.gridLayout.addWidget(self.cmbGroupType, 12, 1, 1, 2)
        ...
        self.lblSetMembership = QtGui.QLabel(MUOMSOFSetupDialog)
        self.lblSetMembership.setObjectName(_fromUtf8("lblSetMembership"))
        self.gridLayout.addWidget(self.lblSetMembership, 13, 0, 1, 1)
        self.cmbSetMembership = QtGui.QComboBox(MUOMSOFSetupDialog)
        self.cmbSetMembership.setObjectName(_fromUtf8("cmbSetMembership"))
        self.cmbSetMembership.addItem(_fromUtf8(""))
        self.cmbSetMembership.addItem(_fromUtf8(""))
        self.gridLayout.addWidget(self.cmbSetMembership, 13, 1, 1, 2)
    ...
    def retranslateUi(self, MUOMSOFSetupDialog):
        MUOMSOFSetupDialog.setWindowTitle(_translate("MUOMSOFSetupDialog", "параметры отчёта", None))
        self.lblFinance.setText(_translate("MUOMSOFSetupDialog", "Тип финансирования", None))
        self.lblBegDate.setText(_translate("MUOMSOFSetupDialog", "Дата &начала периода", None))
        self.lblEndDate.setText(_translate("MUOMSOFSetupDialog", "Дата &окончания периода", None))
        self.lblEventPurpose.setText(_translate("MUOMSOFSetupDialog", "&Назначение обращения", None))
        self.lblEventType.setText(_translate("MUOMSOFSetupDialog", "&Тип обращения", None))
        self.lblOrgStructure.setText(_translate("MUOMSOFSetupDialog", "&Подразделение", None))
        self.lblSpeciality.setText(_translate("MUOMSOFSetupDialog", "&Специальность", None))
        self.cmbSpeciality.setWhatsThis(_translate("MUOMSOFSetupDialog", "<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
...
"<p style=\"-qt-paragraph-type:empty; margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"></p></body></html>", None))
        self.lblPerson.setText(_translate("MUOMSOFSetupDialog", "&Врач", None))
        self.lblContract.setText(_translate("MUOMSOFSetupDialog", "Договор", None))
        self.lblInsurer.setText(_translate("MUOMSOFSetupDialog", "СМО", None))
        self.lblGroupType.setText(_translate("MUOMSOFSetupDialog", "Группировать", None))
        self.cmbGroupType.setItemText(0, _translate("MUOMSOFSetupDialog", "Не группировать", None))
        self.cmbGroupType.setItemText(1, _translate("MUOMSOFSetupDialog", "По профилю события", None))
        self.cmbGroupType.setItemText(2, _translate("MUOMSOFSetupDialog", "По типу события", None))
        self.lblSex.setText(_translate("MUOMSOFSetupDialog", "По&л", None))
        self.cmbSex.setItemText(1, _translate("MUOMSOFSetupDialog", "М", None))
        self.cmbSex.setItemText(2, _translate("MUOMSOFSetupDialog", "Ж", None))
        self.lblAge.setText(_translate("MUOMSOFSetupDialog", "Во&зраст с", None))
        self.lblAgeTo.setText(_translate("MUOMSOFSetupDialog", "по", None))
        self.lblAgeYears.setText(_translate("MUOMSOFSetupDialog", "лет", None))
        self.lblSetMembership.setText(_translate("MUOMSOFSetupDialog", "Принадлежность к городу", None))
        self.cmbSetMembership.setItemText(0, _translate("MUOMSOFSetupDialog", "По адресу пациента", None))
        self.cmbSetMembership.setItemText(1, _translate("MUOMSOFSetupDialog", "По плательщику в договоре", None))
