...
class CStatReportF12Teenagers_2015(CReport):
    def __init__(self, parent):
        CReport.__init__(self, parent)
        title = u'Ф.12. 2.Дети (15-17 лет включительно).'
...
#        result.setAccountAccompEnabled(False)
    ...
    def build(self, params):
        ...
        tableColumns = [
            ...
            ('10%', [u'',                                                       u'из них: юноши',                                     u'',                                           u'5'], CReportBase.AlignRight),
            ('10%', [u'',                                                       u'из них с диагнозом, установленным впервые в жизни', u'всего',                                      u'6'], CReportBase.AlignRight),
            ('10%', [u'',                                                       u'',                                                  u'из них: юноши (из гр.6)' ,                   u'7'], CReportBase.AlignRight),
            ('10%', [u'',                                                       u'',                                                  u'из гр.6: взято под диспансерное наблюдение', u'8'], CReportBase.AlignRight),
            ('10%', [u'Состоит на д.н. на конец периода',                       u'всего',                                             u'',                                           u'9'], CReportBase.AlignRight),
            ('10%', [u'',                                                       u'из них: юноши',                                     u'',                                           u'10'],CReportBase.AlignRight)
            ]
        ...
        table.mergeCells(0, 3, 1, 5) # Всего
        table.mergeCells(1, 3, 2, 1) # Всего
        table.mergeCells(1, 4, 2, 1) # в т.ч. юноши
        table.mergeCells(1, 5, 1, 3) # Впервые
        table.mergeCells(0, 8, 1, 2) # Д.Н.
        table.mergeCells(1, 8, 2, 1) # всего
        table.mergeCells(1, 9, 2, 1) # в т.ч. юноши
