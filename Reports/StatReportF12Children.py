...
MainRows = [
    ...
    ( u'врожденная глаукома', u'18.3', u'Q15.0'),
    ( u'врожденные аномалии системы кровообращения', u'18.4', u'Q20-Q28'),
    ( u'врожденные аномалии тела и шейки матки, другие врожденные аномалии женских половых органов', u'18.5', u'Q51-Q52'),
    ( u'неопределенность пола и псевдогермафродитизм', u'18.6', u'Q56'),
    ( u'врожденные деформации бедра', u'18.7', u'Q65'),
    ( u'врожденный ихтиоз', u'18.8', u'Q80'),
    ( u'нейрофиброматоз', u'18.9', u'Q85.0'),
    ( u'синдром Дауна', u'18.10', u'Q90'),
...
class CStatReportF12Children(CReport):
    def __init__(self, parent):
        CReport.__init__(self, parent)
        title = u'Ф.12 (дети)'
        self.setTitle(title, u'Ф.12 (дети)')
