...
class CStatReportF12Adults_2016(CReport):
    def __init__(self, parent):
        CReport.__init__(self, parent)
        title = u'Ф.12. 4.Взрослые 18 лет и старше.'
        self.setTitle(title, u'Ф.12. 4.Взрослые 18 лет и старше.')
    ...
    def build(self, params):
        ...
        tableColumns = [
            ...
            ('10%', [u'Состоит на д.н. на конец периода',                 u'',                                                                          u'',                                                                    u'15'], CReportBase.AlignRight)
            ]
