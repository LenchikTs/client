...
class CStatReportF12Seniors_2020(CReport):
    def __init__(self, parent):
        CReport.__init__(self, parent)
        title = u'''Ф12. 5.Взрослые старше трудоспособного возраста (с 56 лет у женщин и с 61 лет у мужчин).'''
    ...
    def build(self, params):
        ...
        cursor.insertBlock()
        cursor.insertText(u'(4004) Число лиц с болезнями системы кровообращения, взятых под диспансерное наблюдение (стр. 10.0 гр. 8) - %d, из них умерло %d.' %
