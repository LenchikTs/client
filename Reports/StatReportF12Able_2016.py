...
GROUP BY MKB, diseaseCharacter, firstInPeriod, getObserved, getRemovingObserved, getProfilactic, isNotPrimary, observed, closedEvent, getAdultsDispans, rbDiagnosisType.id
    ...
    cond.append('Diagnosis.endDate <= SUBDATE(ADDDATE(Client.birthDate, INTERVAL IF(Client.sex = 2, 55, IF(Client.sex = 1, 60, 55)) YEAR), 1)')
    if socStatusTypeId:
...
class CStatReportF12Able_2016(CReport):
    def __init__(self, parent):
        CReport.__init__(self, parent)
        title = u'Ф.12. 6.Взрослые трудоспособного возраста (женщины с 18 до 54 лет включительно и мужчины с с 18 до 59 лет включительно).'
        self.setTitle(title, u'Ф.12. 6.Взрослые трудоспособного возраста (женщины с 18 до 54 лет включительно и мужчины с с 18 до 59 лет включительно).')
...
#        result.setAccountAccompEnabled(False)
    ...
    def build(self, params):
        ...
        tableColumns = [
            ...
            ('10%', [u'',                                                 u'из них(из гр. 4):',                                                         u'взято под диспансерное наблюдение',                                   u'6'], CReportBase.AlignRight),
            ('10%', [u'',                                                 u'',                                                                          u'с впервые в жизни установленным диагнозом',                           u'7'], CReportBase.AlignRight),
            ('10%', [u'',                                                 u'из заболеваний с впервые в жизни установленным диагнозом (из гр. 7):',      u'взято под диспансерное наблюдение',                                   u'8'], CReportBase.AlignRight),
            ('10%', [u'',                                                 u'',                                                                          u'выявлено при профосмотре',                                            u'9'], CReportBase.AlignRight),
            ('10%', [u'',                                                 u'',                                                                          u'выявлено при диспансеризации определенных групп взрослого населения', u'10'], CReportBase.AlignRight),
            ('10%', [u'Снято с диспансерного наблюдения',                 u'',                                                                          u'',                                                                    u'12'], CReportBase.AlignRight),
            ('10%', [u'Состоит на д.н. на конец периода',                 u'',                                                                          u'',                                                                    u'13'], CReportBase.AlignRight)
            ]
