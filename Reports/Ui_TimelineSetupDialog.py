...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\Reports\TimelineSetupDialog.ui'
#
...
class Ui_TimelineSetupDialog(object):
    def setupUi(self, TimelineSetupDialog):
        ...
        TimelineSetupDialog.resize(382, 237)
        ...
        self.chkScheduleItemDetail = QtGui.QCheckBox(TimelineSetupDialog)
        self.chkScheduleItemDetail.setObjectName(_fromUtf8("chkScheduleItemDetail"))
        self.gridLayout.addWidget(self.chkScheduleItemDetail, 6, 2, 1, 2)
        self.chkOrgStructureDetail = QtGui.QCheckBox(TimelineSetupDialog)
        self.chkOrgStructureDetail.setObjectName(_fromUtf8("chkOrgStructureDetail"))
        self.gridLayout.addWidget(self.chkOrgStructureDetail, 5, 2, 1, 2)
        ...
        TimelineSetupDialog.setTabOrder(self.cmbPerson, self.chkOrgStructureDetail)
        TimelineSetupDialog.setTabOrder(self.chkOrgStructureDetail, self.chkScheduleItemDetail)
        TimelineSetupDialog.setTabOrder(self.chkScheduleItemDetail, self.buttonBox)
...
"<p style=\"-qt-paragraph-type:empty; margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"></p></body></html>", None))
        ...
        self.chkScheduleItemDetail.setText(_translate("TimelineSetupDialog", "Детализация по номеркам", None))
        self.chkOrgStructureDetail.setText(_translate("TimelineSetupDialog", "Детализация по подразделениям", None))
