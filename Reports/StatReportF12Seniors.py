...
MainRows = [
    ...
    ( u'нарушения обмена гликозами гликанов (мукополисахаридоз)', u'5.13', u'E76.0-3'),
    ...
    ( u'из них: эндокардит, миокардит', u'10.6.2', u'I33'),
    ...
    ( u'внутримозговое кровоизлияние', u'10.7.2', u'I61,I62'),
    ...
    ( u'острый панкреатит', u'12.10.1', u'K85'),
    ...
    ( u'спондилопатии', u'14.4', u'M44-M48'),
...
class CStatReportF12Seniors(CReport):
    def __init__(self, parent):
        CReport.__init__(self, parent)
        title = u'''Взрослые старше трудоспособного возраста (с 55 лет у женщин и с 60 лет у мужчин)'''
