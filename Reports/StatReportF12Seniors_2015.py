...
MainRows = [
    ...
    ( u'эндометриоз', u'15.9', u'N70-N73, N75-N76'),
...
class CStatReportF12Seniors_2015(CReport):
    def __init__(self, parent):
        CReport.__init__(self, parent)
        title = u'''Ф12. 4.Взрослые старше трудоспособного возраста (с 55 лет у женщин и с 60 лет у мужчин).'''
