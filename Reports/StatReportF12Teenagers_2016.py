...
class CStatReportF12Teenagers_2016(CReport):
    ...
    def build(self, params):
        ...
        tableColumns = [
            ...
            ('6.5%', [u'Состоит на д.н. на конец периода',                 u'',                                                                          u'',                                                                    u'15'], CReportBase.AlignRight),
