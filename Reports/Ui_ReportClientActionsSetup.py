...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\Reports\ReportClientActionsSetup.ui'
#
...
class Ui_ReportClientActionsSetupDialog(object):
    def setupUi(self, ReportClientActionsSetupDialog):
        ...
        ReportClientActionsSetupDialog.resize(487, 531)
        ...
        self.chkCoefficient = QtGui.QCheckBox(ReportClientActionsSetupDialog)
        self.chkCoefficient.setObjectName(_fromUtf8("chkCoefficient"))
        self.gridLayout.addWidget(self.chkCoefficient, 8, 1, 1, 4)
        ...
        QtCore.QObject.connect(self.chkClientCode, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.edtClientCode.setEnabled)
        QtCore.QObject.connect(self.chkClientCode, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.cmbAccountingSystem.setEnabled)
        QtCore.QObject.connect(self.chkClientCode, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.edtLastName.setDisabled)
        QtCore.QObject.connect(self.chkClientCode, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.edtFirstName.setDisabled)
        QtCore.QObject.connect(self.chkClientCode, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.edtPatrName.setDisabled)
        QtCore.QObject.connect(self.chkClientCode, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.edtBirthDate.setDisabled)
        QtCore.QObject.connect(self.chkClientCode, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.cmbDocType.setDisabled)
        QtCore.QObject.connect(self.chkClientCode, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.edtLeftSerial.setDisabled)
        QtCore.QObject.connect(self.chkClientCode, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.edtRightSerial.setDisabled)
        QtCore.QObject.connect(self.chkClientCode, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.edtNumber.setDisabled)
        QtCore.QObject.connect(self.chkClientCode, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.cmbPolicyType.setDisabled)
        QtCore.QObject.connect(self.chkClientCode, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.edtPolicySerial.setDisabled)
        QtCore.QObject.connect(self.chkClientCode, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.edtPolicyNumber.setDisabled)
        QtCore.QObject.connect(self.chkClientCode, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.cmbPolicyCompany.setDisabled)
        QtCore.QObject.connect(self.chkClientCode, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.edtContact.setDisabled)
        QtCore.QMetaObject.connectSlotsByName(ReportClientActionsSetupDialog)
        ReportClientActionsSetupDialog.setTabOrder(self.cmbResultType, self.chkDetailDateAndPersonCode)
        ReportClientActionsSetupDialog.setTabOrder(self.chkDetailDateAndPersonCode, self.chkClientCode)
    ...
    def retranslateUi(self, ReportClientActionsSetupDialog):
        ...
        self.cmbResultType.setItemText(1, _translate("ReportClientActionsSetupDialog", "Акт", None))
        ...
        self.chkCoefficient.setText(_translate("ReportClientActionsSetupDialog", "Учитывать коэффициенты", None))
