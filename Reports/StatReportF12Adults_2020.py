...
class CStatReportF12Adults_2020(CReport):
    ...
    def build(self, params):
        ...
        cursor.insertBlock()
        cursor.insertText(u'(3004) Число лиц с болезнями системы кровообращения, взятых под диспансерное наблюдение (стр. 10.0 гр. 8) - %d, из них умерло %d.' %
