...
GROUP BY MKB, diseaseCharacter, sex, firstInPeriod, getObserved, getRemovingObserved, getProfilactic, isNotPrimary, observed, getAdultsDispans, rbDiagnosisType.id
    ...
    cond.append('age(Client.birthDate, Event.setDate) BETWEEN "18" and IF(Client.sex = 1, "60", "55")' )
    if socStatusTypeId:
...
class CStatReportF12Able_2017(CReport):
    ...
    def getSetupDialog(self, parent):
        ...
        for i in xrange(result.gridLayout.count()):
            ...
            if isinstance(spacer, QtGui.QSpacerItem):
                ...
                print itemposition
                if itemposition != (10, 2, 1, 2) and itemposition != (0, 3, 1, 1) and itemposition != (31, 0, 1, 1) and itemposition != (1, 3, 1, 1):
