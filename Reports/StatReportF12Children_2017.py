...
class CStatReportF12Children0_14_2017(CReport):
...
class CStatReportF12Children0_1_2017(CReport):
    def __init__(self, parent):
        CReport.__init__(self, parent)
    ...
    def build(self, params):
        ...
        tableColumns = [
            ...
            ('7%',  [u'',                                                 u'',                                                                     u'взято под диспансерное наблюдение',         u'6'], CReportBase.AlignRight),
            ('7%',  [u'',                                                 u'',                                                                     u'с впервые в жизни установленным диагнозом', u'7'], CReportBase.AlignRight),
            ('7%',  [u'',                                                 u'из заболеваний с впервые в жизни установленным диагнозом (из гр. 7):', u'взято под диспансерное наблюдение',         u'8'], CReportBase.AlignRight),
            ('7%',  [u'',                                                 u'',                                                                     u'выявлено при профосмотре',                  u'9'], CReportBase.AlignRight),
            ('7%',  [u'Снято с диспансерного наблюдения',                 u'',                                                                     u'',                                          u'10'], CReportBase.AlignRight),
            ('7%',  [u'Состоит на д.н. на конец периода',                 u'',                                                                     u'',                                          u'11'], CReportBase.AlignRight)
            ]
