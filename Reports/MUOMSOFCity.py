...
"""
    ...
    if setMembershipIndex:
        ...
        WHERE Client.id IS NOT NULL AND ClientAddress.client_id = Client.id AND kladr.KLADR.CODE LIKE '29%%'
...
class CMUOMSOFCity(CReport):
    name = u'Раздел II. Сведения об оказанной медицинской помощи застрахованному лицу'
    ...
    def build(self, params):
        ...
        cursor.insertBlock()
        cursor.insertText(u'Раздел II. Сведения об оказанной застрахованному лицу медицинской помощи')
        cursor.insertBlock()
