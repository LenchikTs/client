...
class CMUOMSOFTable1(CReport):
    ...
    def getSetupDialog(self, parent):
        ...
        result.setSetMembershipVisible(False)
        return result
...
class CMUOMSOFSetupDialog(CDialogBase, Ui_MUOMSOFSetupDialog):
    def __init__(self, parent=None):
        ...
        self.setSetMembershipVisible(False)
    ...
    def setSetMembershipVisible(self, value):
        self.isSetMembershipVisible = value
        self.lblSetMembership.setVisible(value)
        self.cmbSetMembership.setVisible(value)
    ...
    def setParams(self, params):
        ...
        self.cmbSetMembership.setCurrentIndex(params.get('setMembershipIndex', 0))
    ...
    def params(self):
        ...
        if self.isFinanceVisible:
            result['financeId'] = self.cmbFinance.value()
        if self.isSetMembershipVisible:
            result['setMembershipIndex'] = self.cmbSetMembership.currentIndex()
