...
class CStatReportF12Able_2015(CReport):
    def __init__(self, parent):
        CReport.__init__(self, parent)
        title = u'Ф.12. 5.Взрослые трудоспособного возраста (женщины с 18 до 54 лет включительно и мужчины с с 18 до 59 лет включительно).'
        self.setTitle(title, u'Ф.12. 5.Взрослые трудоспособного возраста (женщины с 18 до 54 лет включительно и мужчины с с 18 до 59 лет включительно).')
