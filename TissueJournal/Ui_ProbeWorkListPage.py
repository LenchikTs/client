...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\TissueJournal\ProbeWorkListPage.ui'
#
...
class Ui_ProbeWorkListWidget(object):
    def setupUi(self, ProbeWorkListWidget):
        ...
        ProbeWorkListWidget.resize(857, 804)
        ...
        self.cmbPWLStatus.addItem(_fromUtf8(""))
        self.cmbPWLStatus.addItem(_fromUtf8(""))
        self.gridLayout_2.addWidget(self.cmbPWLStatus, 11, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.lblPWLProbeIdentifier, 20, 0, 1, 2)
        ...
        self.btnPWLImport.setEnabled(True)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.btnPWLPrint = CPrintButton(self.pnlPWLProbes)
    ...
    def retranslateUi(self, ProbeWorkListWidget):
        ...
        self.cmbPWLStatus.setItemText(7, _translate("ProbeWorkListWidget", "Передано в ЛИС", None))
        self.cmbPWLStatus.setItemText(8, _translate("ProbeWorkListWidget", "Получено из ЛИС", None))
