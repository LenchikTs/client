...
from Stock.Ui_NomenclatureExpense import Ui_NomenclatureExpenseDialog


class CNomenclatureExpenseEditDialog(CStockMotionBaseDialog, Ui_NomenclatureExpenseDialog):
