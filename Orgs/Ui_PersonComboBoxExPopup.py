...
class Ui_PersonComboBoxExPopup(object):
    def setupUi(self, PersonComboBoxExPopup):
        ...
        self.gridlayout1.addWidget(self.buttonBox, 11, 2, 1, 1)
        ...
        self.gridlayout1.addWidget(self.chkDeallocatedPerson, 7, 1, 1, 2)
        ...
        self.chkOnlyDoctors = QtGui.QCheckBox(self.tabSearch)
        self.chkOnlyDoctors.setChecked(True)
        self.chkOnlyDoctors.setObjectName(_fromUtf8("chkOnlyDoctors"))
        self.gridlayout1.addWidget(self.chkOnlyDoctors, 8, 1, 1, 2)
        self.cmbTariffCategory = CRBComboBox(self.tabSearch)
        self.cmbTariffCategory.setObjectName(_fromUtf8("cmbTariffCategory"))
        self.gridlayout1.addWidget(self.cmbTariffCategory, 6, 1, 1, 2)
        self.lblTariffCategory = QtGui.QLabel(self.tabSearch)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lblTariffCategory.sizePolicy().hasHeightForWidth())
        self.lblTariffCategory.setSizePolicy(sizePolicy)
        ...
        PersonComboBoxExPopup.setTabOrder(self.cmbActivity, self.cmbTariffCategory)
        PersonComboBoxExPopup.setTabOrder(self.cmbTariffCategory, self.chkDeallocatedPerson)
        PersonComboBoxExPopup.setTabOrder(self.chkDeallocatedPerson, self.chkOnlyDoctors)
        PersonComboBoxExPopup.setTabOrder(self.chkOnlyDoctors, self.buttonBox)
    ...
    def retranslateUi(self, PersonComboBoxExPopup):
        ...
        self.chkDeallocatedPerson.setText(_translate("PersonComboBoxExPopup", "Уволенные/Заблокированные", None))
        ...
        self.chkOnlyDoctors.setText(_translate("PersonComboBoxExPopup", "Учитывать только врачебные должности", None))
        self.lblTariffCategory.setText(_translate("PersonComboBoxExPopup", "&Тарифная категория", None))
