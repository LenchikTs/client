...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\Resources\JobTemplateDialog.ui'
#
...
class Ui_TemplateDialog(object):
    def setupUi(self, TemplateDialog):
        ...
        self.tblJobs = COrgSrtuctureJobsView(TemplateDialog)
        self.tblJobs.setObjectName(_fromUtf8("tblJobs"))
        self.gridLayout.addWidget(self.tblJobs, 2, 0, 1, 8)
        ...
        self.chkRemoveExistingJobs = QtGui.QCheckBox(TemplateDialog)
        self.chkRemoveExistingJobs.setObjectName(_fromUtf8("chkRemoveExistingJobs"))
        self.gridLayout.addWidget(self.chkRemoveExistingJobs, 3, 0, 1, 8)
        ...
        TemplateDialog.setTabOrder(self.chkFillRedDays, self.tblJobs)
        TemplateDialog.setTabOrder(self.tblJobs, self.chkRemoveExistingJobs)
        TemplateDialog.setTabOrder(self.chkRemoveExistingJobs, self.buttonBox)
    ...
    def retranslateUi(self, TemplateDialog):
        ...
        self.chkRemoveExistingJobs.setText(_translate("TemplateDialog", "Удалить предыдущее расписание", None))
