...
from library.Utils       import calcAgeTuple, firstYearDay, forceDate, forceInt, forceString, forceStringEx, getPref, getPrefBool, getPrefDate, setPref, toVariant

from DataCheck.CCheck    import CCheck
from Registry.Utils      import getClientPolicy

from DataCheck.Ui_Events import Ui_EventsCheckDialog
...
#                                self.err2log(u'диагноз Z назначен сопутствующим')
                ...
                if diagnosisTypeId==1:
                    ...
                    if healthGroupId<1 or healthGroupId>5:
...
#                    self.err2log(u'исслед. '+name+u' раньше начала ДД')
    ...
    def setParams(self, params):
        self.dateEdit_1.setDate(params.get('begDateCheckEvents', QDate.currentDate()))
        self.dateEdit_2.setDate(params.get('endDateCheckEvents', QDate.currentDate()))
