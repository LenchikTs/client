...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\DataCheck\LocalLogicalControlDiagnosisLUD.ui'
#
...
class Ui_LocalLogicalControlDiagnosisLUD(object):
    ...
    def retranslateUi(self, LocalLogicalControlDiagnosisLUD):
        LocalLogicalControlDiagnosisLUD.setWindowTitle(_translate("LocalLogicalControlDiagnosisLUD", "Оперативный логический контроль ЛУДа", None))
        self.chkMKB.setText(_translate("LocalLogicalControlDiagnosisLUD", "Коды диагнозов по &МКБ", None))
        self.edtMKBFrom.setInputMask(_translate("LocalLogicalControlDiagnosisLUD", "a00.00; ", None))
        self.edtMKBFrom.setText(_translate("LocalLogicalControlDiagnosisLUD", "A.", None))
        self.edtMKBTo.setInputMask(_translate("LocalLogicalControlDiagnosisLUD", "a00.00; ", None))
        self.edtMKBTo.setText(_translate("LocalLogicalControlDiagnosisLUD", "T99.9", None))
        self.prbControlDiagnosisLocalLUD.setFormat(_translate("LocalLogicalControlDiagnosisLUD", "%p%", None))
        self.btnStartControlLocalLUD.setText(_translate("LocalLogicalControlDiagnosisLUD", "начать выполнение", None))
        self.btnCorrectControlLocalLUD.setText(_translate("LocalLogicalControlDiagnosisLUD", "исправить", None))
        self.btnEndControlLocalLUD.setText(_translate("LocalLogicalControlDiagnosisLUD", "прервать", None))
