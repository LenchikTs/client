...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\Events\TempInvalidDuplicateEditDialog.ui'
#
...
class Ui_TempInvalidDuplicateEditDialog(object):
    def setupUi(self, TempInvalidDuplicateEditDialog):
        ...
        TempInvalidDuplicateEditDialog.resize(324, 352)
        ...
        self.gridLayout.addWidget(self.chkInsuranceOfficeMark, 9, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.edtDestination, 4, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.lblDestination, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lblReason, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.edtNote, 7, 1, 2, 2)
        ...
        self.gridLayout.addWidget(self.edtPlaceWork, 6, 1, 1, 2)
