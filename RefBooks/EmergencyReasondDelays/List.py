...
from RefBooks.Tables         import rbCode, rbCodeRegional, rbEmergencyReasondDelays, rbName

from .Ui_RBEmergency import Ui_ItemEditorDialog


class CRBEmergencyReasondDelaysList(CItemsListDialog):
    def __init__(self, parent):
        ...
        self.setWindowTitleEx(u'Причины задержки')

    def getItemEditor(self):
        return CRBEmergencyReasondDelaysEditor(self)

#
# ##########################################################################
#

class CRBEmergencyReasondDelaysEditor(CItemEditorBaseDialog, Ui_ItemEditorDialog):
    def __init__(self,  parent):
        CItemEditorBaseDialog.__init__(self, parent, rbEmergencyReasondDelays)
        self.setupUi(self)
