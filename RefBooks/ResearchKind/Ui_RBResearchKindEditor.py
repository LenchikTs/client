...
# Form implementation generated from reading ui file 'D:\soc-inform\RefBooks\ResearchKind\RBResearchKindEditor.ui'
#
...
class Ui_ItemEditorDialog(object):
    def setupUi(self, ItemEditorDialog):
        ...
        ItemEditorDialog.resize(305, 116)
        ...
        self.chkInClientInfoBrowser = QtGui.QCheckBox(ItemEditorDialog)
        self.chkInClientInfoBrowser.setObjectName(_fromUtf8("chkInClientInfoBrowser"))
        self.gridlayout.addWidget(self.chkInClientInfoBrowser, 2, 1, 1, 1)
        ...
        ItemEditorDialog.setTabOrder(self.edtName, self.chkInClientInfoBrowser)
    ...
    def retranslateUi(self, ItemEditorDialog):
        ...
        self.chkInClientInfoBrowser.setText(_translate("ItemEditorDialog", "&Визуализация в шильдике", None))
