...
# Form implementation generated from reading ui file '/home/green/s11_trunk/RefBooks/RBTraumaTypeEditor.ui'
#
...
class Ui_ItemEditorDialog(object):
    def setupUi(self, ItemEditorDialog):
        ...
        ItemEditorDialog.resize(383, 165)
        ...
        self.lblUsishCode.setEnabled(False)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        ItemEditorDialog.setTabOrder(self.edtUsishCode, self.tblIdentification)
