...
# Form implementation generated from reading ui file '/home/green/s11_trunk/RefBooks/RBDiseaseCharacterEditor.ui'
#
...
class Ui_ItemEditorDialog(object):
    def setupUi(self, ItemEditorDialog):
        ...
        ItemEditorDialog.resize(481, 165)
        ...
        self.lblReplaceCode = QtGui.QLabel(self.tabMain)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lblReplaceCode.sizePolicy().hasHeightForWidth())
        self.lblReplaceCode.setSizePolicy(sizePolicy)
        self.lblReplaceCode.setObjectName(_fromUtf8("lblReplaceCode"))
        self.gridLayout.addWidget(self.lblReplaceCode, 2, 0, 1, 1)
        self.edtReplaceCode = QtGui.QLineEdit(self.tabMain)
        self.edtReplaceCode.setObjectName(_fromUtf8("edtReplaceCode"))
        self.gridLayout.addWidget(self.edtReplaceCode, 2, 1, 1, 1)
        spacerItem = QtGui.QSpacerItem(461, 90, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        ...
        self.lblReplaceCode.setBuddy(self.edtReplaceCode)
        ...
        ItemEditorDialog.setTabOrder(self.edtName, self.edtReplaceCode)
        ItemEditorDialog.setTabOrder(self.edtReplaceCode, self.tblIdentification)
    ...
    def retranslateUi(self, ItemEditorDialog):
        ...
        self.lblReplaceCode.setText(_translate("ItemEditorDialog", "В &Диагнозе заменять на ", None))
