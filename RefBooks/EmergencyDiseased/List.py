...
from RefBooks.Tables         import rbCode, rbCodeRegional, rbEmergencyDiseased, rbName

from .Ui_RBEmergency import Ui_ItemEditorDialog


class CRBEmergencyDiseasedList(CItemsListDialog):
    def __init__(self, parent):
        CItemsListDialog.__init__(self, parent, [
            CTextCol(u'Код',          [rbCode], 20),
            CTextCol(u'Региональный код', [rbCodeRegional], 20),
            CTextCol(u'Наименование', [rbName], 40),
            ], rbEmergencyDiseased, [rbCode, rbName])
        self.setWindowTitleEx(u'Больной')

    def getItemEditor(self):
        return CRBEmergencyDiseasedEditor(self)

#
# ##########################################################################
#

class CRBEmergencyDiseasedEditor(CItemEditorBaseDialog, Ui_ItemEditorDialog):
    def __init__(self,  parent):
