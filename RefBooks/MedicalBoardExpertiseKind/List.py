...
class CRBMedicalBoardExpertiseKind(CItemsListDialog):
    def __init__(self, parent):
        CItemsListDialog.__init__(self, parent, [
            CTextCol(u'Код',          [rbCode], 20),
            CTextCol(u'Наименование', [rbName], 40),
            CRefBookCol(u'Характеристика экспертизы', ['expertiseCharacter_id'], 'rbMedicalBoardExpertiseCharacter', 30),
            ], 'rbMedicalBoardExpertiseKind', [rbCode, rbName])
        self.setWindowTitleEx(u'Виды экспертизы')


    def getItemEditor(self):
        return CRBMedicalBoardExpertiseKindEditor(self)

#
# ##########################################################################
#

class CRBMedicalBoardExpertiseKindEditor(Ui_ItemEditorDialog, CItemEditorDialog):
    def __init__(self,  parent):
        CItemEditorDialog.__init__(self, parent, 'rbMedicalBoardExpertiseKind')
        self.setWindowTitleEx(u'Вид экспертизы')
