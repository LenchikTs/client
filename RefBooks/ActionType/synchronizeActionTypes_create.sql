...
`id` INT( 11 ) NOT NULL AUTO_INCREMENT ,
 `code` VARCHAR( 25 ) CHARACTER SET utf8 COLLATE utf8_general_si NOT NULL COMMENT 'Код услуги или группы услуг',
 `name` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_general_si NOT NULL COMMENT 'Название услуги или группы услуг',
 `parentCode` VARCHAR( 23 ) CHARACTER SET utf8 COLLATE utf8_general_si NULL COMMENT 'Код родительского элемента в иерархии',
