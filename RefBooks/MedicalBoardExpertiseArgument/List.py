...
class CRBMedicalBoardExpertiseArgument(CItemsListDialog):
    def __init__(self, parent):
        CItemsListDialog.__init__(self, parent, [
            CTextCol(u'Код',          [rbCode], 20),
            CTextCol(u'Наименование', [rbName], 40),
            CRefBookCol(u'Характеристика экспертизы', ['expertiseCharacter_id'], 'rbMedicalBoardExpertiseCharacter', 30),
            ], 'rbMedicalBoardExpertiseArgument', [rbCode, rbName])
        self.setWindowTitleEx(u'Обоснования экспертизы')


    def getItemEditor(self):
        return CRBMedicalBoardExpertiseArgumentEditor(self)

#
# ##########################################################################
#

class CRBMedicalBoardExpertiseArgumentEditor(Ui_ItemEditorDialog, CItemEditorDialog):
    def __init__(self,  parent):
        CItemEditorDialog.__init__(self, parent, 'rbMedicalBoardExpertiseArgument')
        self.setWindowTitleEx(u'Обоснование экспертизы')
