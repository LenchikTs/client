...
# Form implementation generated from reading ui file '/home/green/s11_trunk/RefBooks/EquipmentsListDialog.ui'
#
# Created: Wed Feb 18 21:35:30 2015
...
class Ui_EquipmentsListDialog(object):
    def setupUi(self, EquipmentsListDialog):
        ...
        QtCore.QObject.connect(self.chkMaintenance, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.cmbMaintenance.setEnabled)
        QtCore.QObject.connect(self.chkMaintenance, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.edtMaintenanceTerm.setEnabled)
        QtCore.QObject.connect(self.chkMaintenance, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.cmbMaintenanceTermType.setEnabled)
        QtCore.QObject.connect(self.chkWarranty, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.cmbWarranty.setEnabled)
        QtCore.QObject.connect(self.chkWarranty, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.edtWarrantyTerm.setEnabled)
        QtCore.QObject.connect(self.chkWarranty, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.cmbWarrantyTermType.setEnabled)
        QtCore.QObject.connect(self.chkEmploymentTerm, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.edtEmploymentTerm.setEnabled)
    ...
    def retranslateUi(self, EquipmentsListDialog):
        EquipmentsListDialog.setWindowTitle(_translate("EquipmentsListDialog", "Список записей", None))
        self.statusBar.setToolTip(_translate("EquipmentsListDialog", "A status bar", None))
        self.statusBar.setWhatsThis(_translate("EquipmentsListDialog", "A status bar.", None))
        self.chkReleaseDate.setText(_translate("EquipmentsListDialog", "Период выпуска", None))
        self.chkEquipmentType.setText(_translate("EquipmentsListDialog", "Тип оборудования", None))
        self.chkModel.setText(_translate("EquipmentsListDialog", "Модель", None))
        self.chkInventoryNumber.setText(_translate("EquipmentsListDialog", "Инвент. номер", None))
        self.chkStatus.setText(_translate("EquipmentsListDialog", "Статус", None))
        self.lblReleaseDateFrom.setText(_translate("EquipmentsListDialog", "С: ", None))
        self.lblReleaseDateTo.setText(_translate("EquipmentsListDialog", "По: ", None))
        self.cmbStatus.setItemText(0, _translate("EquipmentsListDialog", "Не работает", None))
        self.cmbStatus.setItemText(1, _translate("EquipmentsListDialog", "Работает", None))
        self.chkOrgStructure.setText(_translate("EquipmentsListDialog", "Подразделение", None))
        self.chkMaintenance.setText(_translate("EquipmentsListDialog", "ТО", None))
        self.cmbMaintenance.setItemText(0, _translate("EquipmentsListDialog", "Не определено", None))
        self.cmbMaintenance.setItemText(1, _translate("EquipmentsListDialog", "Просрочено", None))
        self.cmbMaintenance.setItemText(2, _translate("EquipmentsListDialog", "Осталось...", None))
        self.cmbMaintenanceTermType.setItemText(0, _translate("EquipmentsListDialog", "Дней", None))
        self.cmbMaintenanceTermType.setItemText(1, _translate("EquipmentsListDialog", "Месяцев", None))
        self.cmbMaintenanceTermType.setItemText(2, _translate("EquipmentsListDialog", "Лет", None))
        self.chkWarranty.setText(_translate("EquipmentsListDialog", "Гарантия", None))
        self.cmbWarranty.setItemText(0, _translate("EquipmentsListDialog", "Не определено", None))
        self.cmbWarranty.setItemText(1, _translate("EquipmentsListDialog", "На гарантии", None))
        self.cmbWarranty.setItemText(2, _translate("EquipmentsListDialog", "Без гарантии", None))
        self.cmbWarranty.setItemText(3, _translate("EquipmentsListDialog", "До истечения осталось...", None))
        self.cmbWarrantyTermType.setItemText(0, _translate("EquipmentsListDialog", "Дней", None))
        self.cmbWarrantyTermType.setItemText(1, _translate("EquipmentsListDialog", "Месяцев", None))
        self.cmbWarrantyTermType.setItemText(2, _translate("EquipmentsListDialog", "Лет", None))
        self.chkEmploymentTerm.setText(_translate("EquipmentsListDialog", "Срок службы (лет)", None))
        self.tblItems.setWhatsThis(_translate("EquipmentsListDialog", "список записей", "ура!"))
        self.label.setText(_translate("EquipmentsListDialog", "всего: ", None))
