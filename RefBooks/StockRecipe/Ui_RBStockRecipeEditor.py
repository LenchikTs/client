...
# Form implementation generated from reading ui file 'C:\projects\samson\UP_s11\client\RefBooks\StockRecipe\RBStockRecipeEditor.ui'
#
...
class Ui_ItemEditorDialog(object):
    ...
    def retranslateUi(self, ItemEditorDialog):
        ...
        self.groupBoxIn.setTitle(_translate("ItemEditorDialog", "Исходные материалы", None))
        self.groupBoxOut.setTitle(_translate("ItemEditorDialog", "Результат ", None))
