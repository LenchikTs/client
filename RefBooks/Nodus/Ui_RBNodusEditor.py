...
# Form implementation generated from reading ui file 'D:\soc-inform\RefBooks\Nodus\RBNodusEditor.ui'
#
...
class Ui_RBNodusEditor(object):
    def setupUi(self, RBNodusEditor):
        RBNodusEditor.setObjectName(_fromUtf8("RBNodusEditor"))
        RBNodusEditor.resize(379, 190)
        RBNodusEditor.setSizeGripEnabled(True)
        self.gridLayout = QtGui.QGridLayout(RBNodusEditor)
        self.gridLayout.setMargin(4)
        self.gridLayout.setSpacing(4)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.tabWidget = QtGui.QTabWidget(RBNodusEditor)
        ...
        self.buttonBox = QtGui.QDialogButtonBox(RBNodusEditor)
        ...
        self.retranslateUi(RBNodusEditor)
        self.tabWidget.setCurrentIndex(0)
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("accepted()")), RBNodusEditor.accept)
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL(_fromUtf8("rejected()")), RBNodusEditor.reject)
        QtCore.QMetaObject.connectSlotsByName(RBNodusEditor)
        RBNodusEditor.setTabOrder(self.tabWidget, self.buttonBox)
        RBNodusEditor.setTabOrder(self.buttonBox, self.edtCode)
        RBNodusEditor.setTabOrder(self.edtCode, self.edtName)
        RBNodusEditor.setTabOrder(self.edtName, self.cmbMKB)
        RBNodusEditor.setTabOrder(self.cmbMKB, self.edtEndDate)
        RBNodusEditor.setTabOrder(self.edtEndDate, self.tblIdentification)

    def retranslateUi(self, RBNodusEditor):
        RBNodusEditor.setWindowTitle(_translate("RBNodusEditor", "Dialog", None))
        self.lblCode.setText(_translate("RBNodusEditor", "&Код", None))
        self.lblName.setText(_translate("RBNodusEditor", "&Наименование", None))
        self.lblMKB.setText(_translate("RBNodusEditor", "&Диагноз", None))
        self.lblEndDate.setText(_translate("RBNodusEditor", "Д&ата окончания", None))
        self.edtEndDate.setDisplayFormat(_translate("RBNodusEditor", "dd.MM.yyyy", None))
        self.lblBegDate.setText(_translate("RBNodusEditor", "Д&ата окончания", None))
        self.edtBegDate.setDisplayFormat(_translate("RBNodusEditor", "dd.MM.yyyy", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabMainInfo), _translate("RBNodusEditor", "&Основная информация", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabIdentification), _translate("RBNodusEditor", "&Идентификация", None))
