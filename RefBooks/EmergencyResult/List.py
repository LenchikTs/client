...
from RefBooks.Tables         import rbCode, rbCodeRegional, rbEmergencyResult, rbName

from .Ui_RBEmergency import Ui_ItemEditorDialog


class CRBEmergencyResultList(CItemsListDialog):
    def __init__(self, parent):
        CItemsListDialog.__init__(self, parent, [
            CTextCol(u'Код',          [rbCode], 20),
            CTextCol(u'Региональный код', [rbCodeRegional], 20),
            CTextCol(u'Наименование', [rbName], 40),
            ], rbEmergencyResult, [rbCode, rbName])
        self.setWindowTitleEx(u'Результаты вызова')


    def getItemEditor(self):
        return CRBEmergencyResultEditor(self)

#
# ##########################################################################
#

class CRBEmergencyResultEditor(CItemEditorBaseDialog, Ui_ItemEditorDialog):
    def __init__(self,  parent):
        CItemEditorBaseDialog.__init__(self, parent, rbEmergencyResult)
        self.setupUi(self)
        self.setWindowTitleEx(u'Результат вызова')
