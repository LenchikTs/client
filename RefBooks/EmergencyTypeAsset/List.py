...
from RefBooks.Tables         import rbCode, rbCodeRegional, rbEmergencyTypeAsset, rbName

from .Ui_RBEmergency import Ui_ItemEditorDialog


class CRBEmergencyTypeAssetList(CItemsListDialog):
    ...
    def getItemEditor(self):
        return CRBEmergencyTypeAssetEditor(self)

#
# ##########################################################################
#

class CRBEmergencyTypeAssetEditor(CItemEditorBaseDialog, Ui_ItemEditorDialog):
    def __init__(self,  parent):
