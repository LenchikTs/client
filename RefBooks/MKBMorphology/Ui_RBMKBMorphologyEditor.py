...
# Form implementation generated from reading ui file '/home/green/s11_trunk/RefBooks/RBMKBMorphologyEditor.ui'
#
...
class Ui_MKBMorphologyEditor(object):
    def setupUi(self, MKBMorphologyEditor):
        ...
        MKBMorphologyEditor.resize(320, 180)
        ...
        sizePolicy.setHeightForWidth(self.lblDiagRange1.sizePolicy().hasHeightForWidth())
        self.lblDiagRange1.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lblDiagRange2.sizePolicy().hasHeightForWidth())
        self.lblDiagRange2.setSizePolicy(sizePolicy)
