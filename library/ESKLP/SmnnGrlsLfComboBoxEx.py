...
from library.ESKLP.SmnnGrlsLfComboBoxPopupEx import CSmnnGrlsLfComboBoxPopupEx
...
__all__ = [ 'CSmnnGrlsLfComboBoxEx',
          ]

class CSmnnGrlsLfComboBoxEx(CROComboBox):
    ...
    def showPopup(self):
        if not self._popup:
            self._popup = CSmnnGrlsLfComboBoxPopupEx(self)
            self.connect(self._popup, SIGNAL('smnnLfFormIdSelected(int)'), self.setValue)
