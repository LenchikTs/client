...
# Form implementation generated from reading ui file 'D:\soc-inform\library\TemperatureListDialog.ui'
#
...
class Ui_TemperatureListDialog(object):
    def setupUi(self, TemperatureListDialog):
        ...
        self.tblTemperatureSheet = CFeedInDocTableView(self.tabTable)
    ...
    def retranslateUi(self, TemperatureListDialog):
        TemperatureListDialog.setWindowTitle(_translate("TemperatureListDialog", "Температурный лист", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabGraphs), _translate("TemperatureListDialog", "Графики", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabTable), _translate("TemperatureListDialog", "Таблица", None))
        self.btnPrint.setText(_translate("TemperatureListDialog", "Печать", None))
        self.btnRetry.setText(_translate("TemperatureListDialog", "Повторить", None))
        self.btnClose.setText(_translate("TemperatureListDialog", "Отмена", None))

from F003.FeedModel import CFeedInDocTableView
