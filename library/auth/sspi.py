...
##
## based on pytds
## https://github.com/denisenkom/pytds/tree/master/pytds
## https://msdn.microsoft.com/en-us/library/windows/desktop/aa380496%28v=vs.85%29.aspx
##
#############################################################################
...
def enum_security_packages():
    ...
    if status != Status.SEC_E_OK:
        raise Exception('SSPI Error {0}'.format(Status.getname(status)))
    try:
