...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\library\ItemsSplitListDialog.ui'
#
...
class Ui_ItemsSplitListDialog(object):
    ...
    def retranslateUi(self, ItemsSplitListDialog):
        ItemsSplitListDialog.setWindowTitle(_translate("ItemsSplitListDialog", "Список записей", None))
        self.tblItems.setWhatsThis(_translate("ItemsSplitListDialog", "список записей", "ура!"))
        self.tblItemGroups.setWhatsThis(_translate("ItemsSplitListDialog", "список записей", "ура!"))
        self.label.setText(_translate("ItemsSplitListDialog", "всего: ", None))
        self.statusBar.setToolTip(_translate("ItemsSplitListDialog", "A status bar", None))
        self.statusBar.setWhatsThis(_translate("ItemsSplitListDialog", "A status bar.", None))
