...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\library\ModelPatientComboBoxPopup.ui'
#
...
class Ui_ModelPatientComboBoxPopup(object):
    def setupUi(self, ModelPatientComboBoxPopup):
        ...
        ModelPatientComboBoxPopup.resize(728, 315)
    ...
    def retranslateUi(self, ModelPatientComboBoxPopup):
        ModelPatientComboBoxPopup.setWindowTitle(_translate("ModelPatientComboBoxPopup", "Form", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabModelPatient), _translate("ModelPatientComboBoxPopup", "Результат поиска", None))
        self.label.setText(_translate("ModelPatientComboBoxPopup", "Квота", None))
        self.chkPreviousMKB.setText(_translate("ModelPatientComboBoxPopup", "Учитывать предварительный диагноз", None))
        self.chkQuotingPatientOnly.setText(_translate("ModelPatientComboBoxPopup", "Учитывать только квоты пациента", None))
        self.chkQuotingEvent.setText(_translate("ModelPatientComboBoxPopup", "Учитывать квоту, определенную в Событии", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabSearch), _translate("ModelPatientComboBoxPopup", "&Поиск", None))
