...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\Exchange\ExportHL7_Wizard_2.ui'
#
...
class Ui_ExportHL7_Wizard_2(object):
    ...
    def retranslateUi(self, ExportHL7_Wizard_2):
        ExportHL7_Wizard_2.setWindowTitle(_translate("ExportHL7_Wizard_2", "Экспорт данных о сотрудниках", None))
        self.label.setText(_translate("ExportHL7_Wizard_2", "Экспортировать в", None))
        self.btnSelectDir.setText(_translate("ExportHL7_Wizard_2", "...", None))
        self.btnExport.setText(_translate("ExportHL7_Wizard_2", "Начать экспорт", None))
        self.checkRAR.setText(_translate("ExportHL7_Wizard_2", "Архивировать rar", None))
