...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\Exchange\ExportRbService_Wizard_2.ui'
#
...
class Ui_ExportRbService_Wizard_2(object):
    ...
    def retranslateUi(self, ExportRbService_Wizard_2):
        ExportRbService_Wizard_2.setWindowTitle(_translate("ExportRbService_Wizard_2", "Экспорт типов действий", None))
        self.label.setText(_translate("ExportRbService_Wizard_2", "Экспортировать в", None))
        self.btnSelectFile.setText(_translate("ExportRbService_Wizard_2", "...", None))
        self.btnExport.setText(_translate("ExportRbService_Wizard_2", "Начать экспорт", None))
        self.checkRAR.setText(_translate("ExportRbService_Wizard_2", "Архивировать rar", None))
