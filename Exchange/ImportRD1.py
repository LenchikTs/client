...
from library.Utils import forceInt, forceRef, forceString, forceStringEx, get_date, getVal, toVariant
...
from Exchange.Utils import dbfCheckNames, getId, tbl

from Exchange.Ui_ImportRD1 import Ui_Dialog
...
class CImportRD1(QtGui.QDialog, Ui_Dialog, CDBFimport):
    ...
    def on_btnSelectFile_clicked(self):
        ...
        if fileName != '':
            ...
            dbfRD1 = Dbf(dbfFileName, readOnly=True, encoding='cp866')
