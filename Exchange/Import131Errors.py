...
from PyQt4.QtCore import QDir, QFile, QXmlStreamReader, pyqtSignature
...
from Exchange.Ui_Import131Errors import Ui_Import131ErrorsDialog
...
#            nameEventType = db.translate(self.tableEventType, 'id', eventTypeId, 'name')
    ...
    def on_btnImportFrom_clicked(self):
        ...
        if fileName:
            self.edtImportFrom.setText(QDir.toNativeSeparators(fileName))
