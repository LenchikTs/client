...
# Form implementation generated from reading ui file 'D:\Samson\UP_s11\client_test\Exchange\ImportPayRefuseR53.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Загрузка отказов оплаты для Новгородской области", None))
