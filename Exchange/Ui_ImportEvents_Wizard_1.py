...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\Exchange\ImportEvents_Wizard_1.ui'
#
...
class Ui_ImportEvents_Wizard_1(object):
    ...
    def retranslateUi(self, ImportEvents_Wizard_1):
        ImportEvents_Wizard_1.setWindowTitle(_translate("ImportEvents_Wizard_1", "Импорт типов событий", None))
        self.label.setText(_translate("ImportEvents_Wizard_1", "Загрузить из", None))
        self.btnSelectFile.setText(_translate("ImportEvents_Wizard_1", "...", None))
        self.groupBox.setTitle(_translate("ImportEvents_Wizard_1", "Совпадающие записи", None))
        self.rbAskUser.setText(_translate("ImportEvents_Wizard_1", "Спрашивать действие у пользователя", None))
        self.rbUpdate.setText(_translate("ImportEvents_Wizard_1", "Обновлять", None))
        self.rbSkip.setText(_translate("ImportEvents_Wizard_1", "Пропускать", None))
        self.chkFullLog.setText(_translate("ImportEvents_Wizard_1", "Подробный отчет", None))
