...
from Exchange.Ui_ExportActionTemplate_Wizard_1 import Ui_ExportActionTemplate_Wizard_1
from Exchange.Ui_ExportActionTemplate_Wizard_2 import Ui_ExportActionTemplate_Wizard_2


def ExportActionTemplate():
    fileName = forceString(QtGui.qApp.preferences.appPrefs.get('ExportActionTemplateFileName', ''))
    exportAll = forceBool(QtGui.qApp.preferences.appPrefs.get('ExportActionTemplateExportAll', 'False'))
    compressRAR = forceBool(QtGui.qApp.preferences.appPrefs.get('ExportActionTemplateCompressRAR', 'False'))
...
actionPropertyTypeFields = ('idx', 'name', 'descr', 'var', 'expr', 'typeName', 'valueDomain',
...
ownerFields = ('lastName', 'firstName', 'patrName', 'specialityName','postName')
    ...
    def writeActionProperty(self,  record):
        ...
        if typeId:
            ...
            if typeInfo:
                ...
                propertyValue = forceString(actionPropertyType.getValue(id))
