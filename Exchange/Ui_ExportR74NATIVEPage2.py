...
# Form implementation generated from reading ui file 'C:\PROJECTS\soc-inform\Exchange\ExportR74NATIVEPage2.ui'
#
# Created: Thu Jun 16 13:30:32 2016
...
class Ui_ExportR74NATIVEPage2(object):
    ...
    def retranslateUi(self, ExportR74NATIVEPage2):
        ...
        self.lblDir.setText(_translate("ExportR74NATIVEPage2", "Сохранить в директорий", None))
...
if __name__ == "__main__":
    ...
    ExportR74NATIVEPage2 = QtGui.QWidget()
    ui = Ui_ExportR74NATIVEPage2()
    ui.setupUi(ExportR74NATIVEPage2)
    ExportR74NATIVEPage2.show()
    sys.exit(app.exec_())
