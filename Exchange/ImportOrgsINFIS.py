...
from Exchange.Ui_ImportOrgsINFIS import Ui_Dialog
...
def ImportOrgsINFIS(widget):
    ...
    dlg.edtFileName.setText(forceString(QtGui.qApp.preferences.appPrefs.get('ImportOrgsINFISFileName',  '')))
    dublicates = forceInt(QtGui.qApp.preferences.appPrefs.get('ImportOrgsINFISgbDublicates',  1))
    if dublicates == 0:
...
#        db = QtGui.qApp.db
        ...
        dbfOrgs = Dbf(dbfFileName, readOnly=True, encoding='cp866')
