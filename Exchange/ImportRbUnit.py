...
from library.Utils import anyToUnicode, exceptionToUnicode, forceBool, forceRef, forceString, toVariant

from Exchange.ExportRbUnit import rbUnitFields
from Exchange.Utils import tbl

from Exchange.Ui_ImportRbUnit_Wizard_1 import Ui_ImportRbUnit_Wizard_1
from Exchange.Ui_ImportRbUnit_Wizard_2 import Ui_ImportRbUnit_Wizard_2
from Exchange.Ui_ImportRbUnit_Wizard_3 import Ui_ImportRbUnit_Wizard_3


def ImportRbUnit(parent):
    dlg = CImportRbUnit(forceString(QtGui.qApp.preferences.appPrefs.get('ImportRbUnitFileName', '')),
...
class CMyXmlStreamReader(QXmlStreamReader):
    ...
    def readUnit(self,  filterList,  makeList):
        ...
        if filterList != []:
            if (code, name) not in filterList:
                return None
