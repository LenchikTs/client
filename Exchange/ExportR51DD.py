...
from PyQt4.QtCore import Qt, QDate, QDir, pyqtSignature, SIGNAL

from library.dbfpy.dbf import Dbf
from library.Utils     import firstMonthDay, forceBool, forceDate, forceInt, forceRef, forceString, forceStringEx, formatSex, formatSNILS, getVal, nameCase, pyDate, toVariant, trim

from Events.Action import CAction
from Exchange.ExportLOFOMS import myFormatAddress
from Registry.Utils import getAttachRecord

from Exchange.Ui_ExportR51DDPage1 import Ui_ExportR51DDPage1
from Exchange.Ui_ExportR51DDPage2 import Ui_ExportR51DDPage2
...
#        clientDDAttachRecord = getAttachRecord(clientId, True)
        ...
        if not locKLADRCode or locKLADRCode == '':
            ...
            townCode = forceString(QtGui.qApp.db.translate('kladr.KLADR', 'CODE', locKLADRCode, 'infis'))
    ...
    def exportServices(self, dbfS, codeLPU, accNumber, eventId, endDate):
        ...
        while query.next():
            ...
            if record:
                ...
                if actionId not in self.exportedActionsList:
...
class CExportR51DDPage2(QtGui.QWizardPage, Ui_ExportR51DDPage2):
    ...
    def on_btnSelectDir_clicked(self):
        dir = QtGui.QFileDialog.getExistingDirectory(self,
                u'Выберите директорий для сохранения файла выгрузки в ОМС Мурманской области',
