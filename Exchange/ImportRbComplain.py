...
from PyQt4.QtCore import Qt, QFile, QXmlStreamReader, pyqtSignature, SIGNAL

from library.Utils      import anyToUnicode, exceptionToUnicode, forceBool, forceRef, forceString, toVariant

from Exchange.ExportRbComplain import rbComplainFields
from Exchange.Utils import tbl

from Exchange.Ui_ImportRbComplain import Ui_ImportRbComplain


def ImportRbComplain(parent):
    fileName = forceString(QtGui.qApp.preferences.appPrefs.get('ImportRbComplainFileName', ''))
    fullLog = forceBool(QtGui.qApp.preferences.appPrefs.get('ImportRbComplainFullLog', ''))
