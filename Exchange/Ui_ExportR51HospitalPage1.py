...
# Form implementation generated from reading ui file 'D:\Samson\UP_s11\client_test\Exchange\ExportR51HospitalPage1.ui'
#
...
class Ui_ExportPage1(object):
    def setupUi(self, ExportPage1):
        ...
        self.gridlayout.addWidget(self.chkIgnoreErrors, 4, 0, 1, 1)
        ...
        self.gridlayout.addWidget(self.btnExport, 9, 1, 1, 1)
        self.lblExportType = QtGui.QLabel(ExportPage1)
        self.lblExportType.setObjectName(_fromUtf8("lblExportType"))
        self.gridlayout.addWidget(self.lblExportType, 1, 0, 1, 1)
        ...
        self.cmbExportType.addItem(_fromUtf8(""))
        self.cmbExportType.addItem(_fromUtf8(""))
        self.gridlayout.addWidget(self.cmbExportType, 1, 1, 1, 2)
        self.lblExportFormat = QtGui.QLabel(ExportPage1)
        self.lblExportFormat.setObjectName(_fromUtf8("lblExportFormat"))
        self.gridlayout.addWidget(self.lblExportFormat, 2, 0, 1, 1)
        self.cmbExportFormat = QtGui.QComboBox(ExportPage1)
        self.cmbExportFormat.setObjectName(_fromUtf8("cmbExportFormat"))
        self.cmbExportFormat.addItem(_fromUtf8(""))
        self.cmbExportFormat.addItem(_fromUtf8(""))
        self.cmbExportFormat.addItem(_fromUtf8(""))
        self.gridlayout.addWidget(self.cmbExportFormat, 2, 1, 1, 2)
        ...
        self.gridlayout.addWidget(self.lblElapsed, 8, 0, 1, 3)
    ...
    def retranslateUi(self, ExportPage1):
        ...
        self.cmbExportType.setItemText(0, _translate("ExportPage1", "СМО", None))
        self.cmbExportType.setItemText(1, _translate("ExportPage1", "ТФОМС", None))
        self.cmbExportType.setItemText(2, _translate("ExportPage1", "Диализ", None))
        self.cmbExportType.setItemText(3, _translate("ExportPage1", "Дневной стационар", None))
        self.lblExportFormat.setText(_translate("ExportPage1", "Формат", None))
        self.cmbExportFormat.setItemText(0, _translate("ExportPage1", "2019", None))
        self.cmbExportFormat.setItemText(1, _translate("ExportPage1", "2020", None))
        self.cmbExportFormat.setItemText(2, _translate("ExportPage1", "2021", None))
