...
#        db = QtGui.qApp.db
        ...
        self.labelNum.setText(u'всего записей в источнике: %d' % len(dbfTariff))
        ...
        self.amount =  0
        self.unitId = forceRef(QtGui.qApp.db.translate('rbMedicalAidUnit', 'code', '6', 'id'))
...
#            return
    ...
    def processTariff(self,  row):
        ...
        serviceId = self.findServiceByInfisCode(serviceCode) or self.findServiceByCode(serviceCode)
    ...
    def findServiceByCode(self, code):
        return forceRef(QtGui.qApp.db.translate('rbService', 'code', code, 'id'))
