...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\Exchange\ImportRbThesaurus.ui'
#
...
class Ui_ImportRbThesaurus(object):
    ...
    def retranslateUi(self, ImportRbThesaurus):
        ImportRbThesaurus.setWindowTitle(_translate("ImportRbThesaurus", "Импорт Тезауруса", None))
        self.label.setText(_translate("ImportRbThesaurus", "Загрузить из", None))
        self.btnSelectFile.setText(_translate("ImportRbThesaurus", "...", None))
        self.btnImport.setText(_translate("ImportRbThesaurus", "Начать импорт", None))
        self.btnAbort.setText(_translate("ImportRbThesaurus", "Прервать", None))
        self.btnClose.setText(_translate("ImportRbThesaurus", "Закрыть", None))
        self.chkFullLog.setText(_translate("ImportRbThesaurus", "Подробный отчет", None))
