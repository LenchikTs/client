...
u"""Экспорт реестра  в формате XML. Республика Калмыкия, СМП V59"""
...
def exportR08EmergencyV59(widget, accountId, accountItemIdList, _):
...
if __name__ == '__main__':
    ...
    testAccountExport(exportR08EmergencyV59, 270)
