...
from Exchange.ExportRbThesaurus import rbThesaurusFields
from Exchange.Utils import tbl

from Exchange.Ui_ImportRbThesaurus import Ui_ImportRbThesaurus


def ImportRbThesaurus(parent):
    fileName = forceString(QtGui.qApp.preferences.appPrefs.get('ImportRbThesaurusFileName', ''))
    fullLog = forceBool(QtGui.qApp.preferences.appPrefs.get('ImportRbThesaurusFullLog', ''))
