...
class FHIRBadRequestException(Exception):
...
class FHIRUnprocessableEntityException(Exception):
...
class FHIRServer(object):
    ...
    def _get(self, path, headers={}, nosign=False):
        ...
        # perform the request but intercept 4xx responses, raising our own Exception
    ...
    def raise_for_status(self, response):
        ...
        if 400 == response.status_code:
            raise FHIRBadRequestException(response)
        ...
        elif 422 == response.status_code:
            raise FHIRUnprocessableEntityException(response)
        else:
