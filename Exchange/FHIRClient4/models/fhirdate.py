...
class FHIRDate(object):
    ...
    def __init__(self, jsonval=None):
        ...
        if jsonval is not None:
            ...
            if not isstr:
                raise TypeError("Expecting string when initializing {0}, but got {1}"
            ...
            try:
                ...
                logger.warning("Failed to initialize FHIRDate from \"{0}\": {1}"
                    .format(jsonval, e))
    ...
    def with_json(cls, jsonobj):
        ...
        raise TypeError("`cls.with_json()` only takes string or list of strings, but you provided {0}"
            .format(type(jsonobj)))
