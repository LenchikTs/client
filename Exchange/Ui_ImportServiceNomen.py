...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\Exchange\ImportServiceNomen.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Загрузка услуг из номенкулатуры", None))
        self.label.setText(_translate("Dialog", "импортировать из каталога", None))
        self.btnOpen.setText(_translate("Dialog", "Выбрать...", None))
        self.btnImport.setText(_translate("Dialog", "Начать импорт", None))
