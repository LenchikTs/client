...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\Exchange\ExportRbResult_Wizard_2.ui'
#
...
class Ui_ExportRbResult_Wizard_2(object):
    ...
    def retranslateUi(self, ExportRbResult_Wizard_2):
        ExportRbResult_Wizard_2.setWindowTitle(_translate("ExportRbResult_Wizard_2", "Экспорт результатов событий", None))
        self.label.setText(_translate("ExportRbResult_Wizard_2", "Экспортировать в", None))
        self.btnSelectFile.setText(_translate("ExportRbResult_Wizard_2", "...", None))
        self.btnExport.setText(_translate("ExportRbResult_Wizard_2", "Начать экспорт", None))
        self.checkRAR.setText(_translate("ExportRbResult_Wizard_2", "Архивировать rar", None))
