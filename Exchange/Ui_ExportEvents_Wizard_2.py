...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\Exchange\ExportEvents_Wizard_2.ui'
#
...
class Ui_ExportEvents_Wizard_2(object):
    ...
    def retranslateUi(self, ExportEvents_Wizard_2):
        ExportEvents_Wizard_2.setWindowTitle(_translate("ExportEvents_Wizard_2", "Экспорт типов действий", None))
        self.label.setText(_translate("ExportEvents_Wizard_2", "Экспортировать в", None))
        self.btnSelectFile.setText(_translate("ExportEvents_Wizard_2", "...", None))
        self.btnExport.setText(_translate("ExportEvents_Wizard_2", "Начать экспорт", None))
        self.checkRAR.setText(_translate("ExportEvents_Wizard_2", "Архивировать rar", None))
