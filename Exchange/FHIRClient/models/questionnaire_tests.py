...
class QuestionnaireTests(unittest.TestCase):
    ...
    def implQuestionnaire2(self, inst):
        self.assertEqual(inst.contained[0].id, "ll2655-0")
        self.assertEqual(inst.contained[1].id, "ll2657-6")
        self.assertEqual(inst.contained[2].id, "ll2659-2")
        self.assertEqual(inst.contained[3].id, "ll2660-0")
        self.assertEqual(inst.contained[4].id, "ll2661-8")
        self.assertEqual(inst.contained[5].id, "ll2662-6")
        self.assertEqual(inst.contained[6].id, "ll2663-4")
        self.assertEqual(inst.contained[7].id, "ll2664-2")
        self.assertEqual(inst.contained[8].id, "ll2665-9")
        self.assertEqual(inst.contained[9].id, "ll2817-6")
