...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 0.5.0.5149 (http://hl7.org/fhir/StructureDefinition/Conformance) on 2016-03-29.
...
class Conformance(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
#            ("acceptUnknown", "acceptUnknown", bool, False, None, True),
            ("acceptUnknown", "acceptUnknown", bool, False, None, False),
...
class ConformanceMessagingEvent(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("mode", "mode", str, False, None, True),
            ("protocol", "protocol", coding.Coding, True, None, False),
...
class ConformanceRest(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("documentMailbox", "documentMailbox", str, True, None, False),
            ("documentation", "documentation", str, False, None, False),
...
class ConformanceRestResource(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("conditionalDelete", "conditionalDelete", bool, False, None, False),
