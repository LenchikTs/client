...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 0.5.0.5149 (http://hl7.org/fhir/StructureDefinition/AuditEvent) on 2016-03-29.
...
class AuditEventObject(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("lifecycle", "lifecycle", str, False, None, False),
            ...
            ("sensitivity", "sensitivity", codeableconcept.CodeableConcept, False, None, False),
...
class AuditEventParticipant(backboneelement.BackboneElement):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("userId", "userId", str, False, None, False),
        ])
        return js
