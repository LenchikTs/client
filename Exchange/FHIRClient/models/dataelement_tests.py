...
class DataElementTests(unittest.TestCase):
    ...
    def implDataElement3(self, inst):
        ...
        self.assertEqual(inst.contained[0].id, "vm-valueset")
        self.assertEqual(inst.contained[1].id, "pv-valueset")
        self.assertEqual(inst.contained[2].id, "pv-conceptmap")
        self.assertEqual(inst.contained[3].id, "sub-org")
