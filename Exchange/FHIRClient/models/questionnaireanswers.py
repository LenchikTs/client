...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 0.5.0.5149 (http://hl7.org/fhir/StructureDefinition/QuestionnaireAnswers) on 2016-03-29.
...
class QuestionnaireAnswers(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("group", "group", QuestionnaireAnswersGroup, False, None, False),
...
class QuestionnaireAnswersGroup(backboneelement.BackboneElement):
    """ Grouped questions.
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("group", "group", QuestionnaireAnswersGroup, True, None, False),
            ("linkId", "linkId", str, False, None, False),
            ("question", "question", QuestionnaireAnswersGroupQuestion, True, None, False),
            ("subject", "subject", fhirreference.FHIRReference, False, None, False),
...
class QuestionnaireAnswersGroupQuestion(backboneelement.BackboneElement):
    """ Questions in this group.
    ...
    def elementProperties(self):
        ...
        js.extend([
            ("answer", "answer", QuestionnaireAnswersGroupQuestionAnswer, True, None, False),
            ("group", "group", QuestionnaireAnswersGroup, True, None, False),
            ("linkId", "linkId", str, False, None, False),
            ("text", "text", str, False, None, False),
        ])
...
class QuestionnaireAnswersGroupQuestionAnswer(backboneelement.BackboneElement):
    """ The response(s) to the question.
