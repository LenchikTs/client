...
# Form implementation generated from reading ui file 'D:\PROJECTS\samson\UP_s11\client_test\Accounting\InstantAccountDialog.ui'
#
...
class Ui_InstantAccountDialog(object):
    def setupUi(self, InstantAccountDialog):
        ...
        InstantAccountDialog.setTabOrder(self.edtAccountItemsRefused, self.buttonBox)
