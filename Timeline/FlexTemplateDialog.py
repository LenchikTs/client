...
from Timeline.Ui_FlexTemplateDialog import Ui_FlexTemplateDialog


class CFlexTemplateDialog(CDialogBase, Ui_FlexTemplateDialog):
    def __init__(self, parent):
        ...
        self.modelTimeTable.setPeriod(0, 1)
        ...
        self.tblTimeTable.enableColsMove()
